...
class EmployeeRoster {
    ...
    public function add(Employee $employee) {
        foreach ($this->roster as $existingEmployee) {
            if ($existingEmployee !== null && $existingEmployee->getName() === $employee->getName()) {
    ...
    public function displayEmployees($employeeArray) {
        ...
        foreach ($employeeArray as $index => $employee) {
            if ($employee instanceof Employee) {
                ...
                echo "Company    : " . $employee->getCN() . "\n";
                echo "Type       : " . get_class($employee) . "\n";
                
                if ($employee instanceof CommissionEmployee) {
                    echo "Regular Salary : " . $employee->getRS() . "\n";
                    echo "Items Sold     : " . $employee->getIS() . "\n";
                    echo "Commission Rate: " . $employee->getCR() . "\n";
                } elseif ($employee instanceof HourlyEmployee) {
                    echo "Hours Worked : " . $employee->getHW() . "\n";
                    echo "Hourly Rate  : " . $employee->getrate() . "\n";
                } elseif ($employee instanceof PieceWorker) {
                    echo "Pieces Completed: " . $employee->getNI() . "\n";
                    echo "Wage Per Piece : " . $employee->getWPI() . "\n";
                }
